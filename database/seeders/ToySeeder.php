...
class ToySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $toy->photo="https://res.cloudinary.com/dlnrzmzjf/image/upload/v1736343310/3706bf10-hdg_111812852_6_vyz1mc.png";
        ...
        $toy->photo="https://res.cloudinary.com/dlnrzmzjf/image/upload/v1736343310/ba1fb731-hdg_111812852_5_atid8c.png";
        $toy->description="Wood'n Play - Carrito animal (varios modelos), un pequeño animal de madera con ruedas para llevarlo a pasear y vivir grandes aventuras.\n\nEste juguete es fácil de sostener y manipular por lo que ayuda a los niños a desarrollar sus habilidades motoras.";
        $toy->min_age=0;
        $toy->save();
        ...
        $toy = new Toy();
        $toy->name="Carbón mineral";
        $toy->photo="https://res.cloudinary.com/albertokz/image/upload/v1734348756/Toys/ssyeqxh5t8xuhtjvg7dp.png";
        $toy->description="Un pedacito oscuro y brillante de la naturaleza, símbolo tradicional para quienes necesitan mejorar su comportamiento. Perfecto para añadir un toque travieso al espíritu navideño.";
        $toy->min_age=0;
        $toy->save();

        $toy = new Toy();
        $toy->name="Carbón vegetal";
        $toy->photo="https://res.cloudinary.com/albertokz/image/upload/v1734524268/Toys/aelvffhnxcuyil41v2m4.png";
        $toy->description="Ligero y con un toque rústico, este clásico de la tradición navideña es el recordatorio perfecto para quienes tienen espacio para portarse mejor el próximo año.";
        $toy->min_age=0;
        $toy->save();

        $toy = new Toy();
        $toy->name="Carbón calcito";
        $toy->photo="https://res.cloudinary.com/albertokz/image/upload/v1734529083/Toys/iplueuft7eweu4lrxhnm.png";
        $toy->description="una rareza ficticia con un brillo cristalino y un toque de mineralidad, ideal para los que necesitan un recordatorio único de que siempre hay margen para mejorar.";
        $toy->min_age=0;
        $toy->save();

        $toy = new Toy();
        $toy->name="Viaje a Disneyland Paris";
        $toy->photo="https://res.cloudinary.com/dlnrzmzjf/image/upload/v1736342616/Viaje-Disney_ucazam.webp";
        $toy->description="Un viaje a Disneyland: magia, aventura y diversión en cada rincón, donde los sueños cobran vida y la imaginación no tiene límites. ¡Una experiencia inolvidable para todas las edades!";
        $toy->min_age=18;
        $toy->save();

        $toy = new Toy();
        $toy->name="Viaje a Warner Bros Madrid";
        $toy->photo="https://res.cloudinary.com/dlnrzmzjf/image/upload/v1736342616/Viaje-Warner_khaei3.jpg";
        $toy->description="Un viaje al Parque Warner de Madrid: emoción y entretenimiento al estilo de tus personajes favoritos, con espectáculos, montañas rusas y diversión para toda la familia. ¡Una aventura de película!";
        $toy->min_age=18;
        $toy->save();

        $toy = new Toy();
        $toy->name="Viaje a la Luna";
        $toy->photo="https://res.cloudinary.com/dlnrzmzjf/image/upload/v1736342616/Viaje-Luna_zjdf3j.jpg";
        $toy->description="Un viaje a la Luna: una experiencia fuera de este mundo, explorando paisajes extraterrestres, flotando en gravedad cero y contemplando la Tierra desde un horizonte cósmico. ¡La aventura definitiva!";
        $toy->min_age=18;
        $toy->save();
    }
}
